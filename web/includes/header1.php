												...
												<ul class="nav navbar-nav navbar-right">
                                                    ...
                                                    <li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li class="dropdown">
																<a href="sequence.php" class="dropdown-toggle" data-toggle="dropdown">BLAST/RGI</a>
                                                            </li>
															<li class="dropdown">
																<a href="search.php" class="dropdown-toggle" data-toggle="dropdown">Search</a>
                                                            </li>
                                                            <li class="dropdown">
																<a href="advanced_search.php" class="dropdown-toggle" data-toggle="dropdown">Advanced Search</a>
                                                            </li>
														</ul>
													</li>
													<li class="dropdown">
