...
<?php
			...
			$stmt->execute();	
			$total_IDs=$stmt->fetch(PDO::FETCH_ASSOC);
			...
			$stmt = $conn->prepare("SELECT count(*) as dc  from Assemly where Is_Reference='0' ");
			$stmt->execute();	
			$searched_Gen=$stmt->fetch(PDO::FETCH_ASSOC);
			  	...
			  	<h3 align="center"><font style="color: #01A9DB;">Stats of AMR-DB</font></h3>
			        <table class=".table-striped ">
			            ...
			            <tr>
			             ...
			             <tr>
			                <td>Total Genome Searched</td>
			                <td><?php echo $searched_Gen['dc'] ;?></td>
			            </tr>
