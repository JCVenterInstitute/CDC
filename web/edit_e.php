                              ...
                              <div class="row">
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="gene_symbol" id="gene_symbol" value="<?php echo $ids[1]; ?>">
                                        </div>
                                    </div>
                                      <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label for="gene_symbol" class="control-label">Gene Family</label>
                                            <input type="text" class="form-control" name="gene_family" id="gene_symbol" value="<?php echo $ids[2]; ?>">
                                        </div>
                                    </div>
                                      <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label for="gene_symbol" class="control-label">Gene Class</label>
                                            <input type="text" class="form-control" name="gene_class" id="gene_symbol" value="<?php echo $ids[3]; ?>">
                                        </div>
                                    </div>
                                     <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                     ...
                                     <script type="text/javascript"> count++;</script>
                                            ...
                                            <h2>Classification $class_parent_count</h2> 
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="drug[]" id="drug_name" placeholder="e.g. Beta-lactam" value='$loop_varian_class[1]'>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1"> 
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name = "drug_class[]" id="drug_class" placeholder="e.g. Class_C_Carbapenemase" value='$loop_varian_class[2]'>
                                                    </div>
                                            </div> 
                                            <div class="col-sm-10 col-sm-offset-1"> 
                                                <div class="form-group">
                                                        <label for="drug_family" class="control-label">Drug Family</label>
                                                        <input type="text" class="form-control" name="drug_family[]" id="drug_family" placeholder="e.g. Beta-lactam" value='$loop_varian_class[3]'>
                                                    </div>
                                            </div>
                                              <div class="col-sm-10 col-sm-offset-1"> 
                                                <div class="form-group">
                                                        <label for="drug_family" class="control-label">Mechanism of Action</label>
                                                        <input type="text" class="form-control" name="mechanism_of_action[]" id="mechanism_of_action" placeholder="e.g. Beta-lactam" value='$loop_varian_class[5]'>
                                                    </div>
                                            </div>
                                            <fieldset class="col-sm-10 col-sm-offset-1" id="">
                                            <h4 >Variants</h4>
...
TT;
                                         ...
                                         while ($loop_va_child=mysql_fetch_array($query_child)) {
                                            ...
                                            <div id="deleteMe$va_child_count+$class_parent_count" >
                                                <div class="col-sm-10 col-sm-offset-1">
HH;
                                            ...
                                            $tempContent2.=<<<HH
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="snp[$class_parent_count][]" id="snp" placeholder="e.g. Y114F,M109I,V165I"  value='$loop_va_child[1]'>
                                                        </div>
                                                </div>
                                                <div class="col-sm-10 col-sm-offset-1"> 
                                                         <div class="form-group">
                                                            <label for="pubmed" class="control-label">Variant PubMed ID</label>
                                                            <input type="text" class="form-control" name="vpubID[$class_parent_count][]" id="protein_name" value='$loop_va_child[2]'>
                                        ...
                                        <div id="deleteMe$va_child_count+$class_parent_count" >
                                           <script type="text/javascript"> count++;</script>
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1"> 
                                                <div class="form-group">
                                                        <label for="pubmed" class="control-label">Variant PubMed ID</label>
                                                        <input type="text" class="form-control" name="vpubID[$class_parent_count][]" id="protein_name" value=''>
...
HH;
                                ...
                                $add_button_php=<<<HAHA
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1">    
                                                <br>
                                                <INPUT TYPE="Button" class="control-label"onClick="addRow('vant_div$class_parent_count','varant')" VALUE="+ Add Variant">
                                            </div>
HAHA;
...
HAHA;
                    $second_tab_content[].=$add_class_btn;
                                ...
                                echo implode('',$second_tab_content);
                            ?>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label for="antibiotic" class="control-label">Antibiotic</label>
                                        <input type="text" name="antibiotic[]" class="form-control" id="antibiotic" value='$loop_varian_class[1]'>
                                    </div>                                  
                                </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                                                 
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Taxonomy ID</label>
                                                <input type="text" class="form-control" name ="tax_id" id="anti" placeholder="e.g. " value ="<?php echo $tax[1]; ?>">
                                        </div>                                  
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1">                                                                 
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Taxon Kingdom</label>
                                                <input type="text" class="form-control" name ="taxon_kingdom" id="anti" placeholder="e.g. " value ="<?php echo $tax[2]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                                                 
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Phylum</label>
                                                <input type="text" class="form-control" name ="phylum" id="anti" placeholder="e.g. Proteobacteria" value ="<?php echo $tax[3]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                                                 
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Taxon Bacterial BioVar</label>
                                                <input type="text" class="form-control" name ="taxon_bacterial_bioVar" id="anti" placeholder="e.g. " value ="<?php echo $tax[4]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Class</label>
                                                <input type="text" class="form-control" name = "class_anti" id="anti" placeholder="e.g. Enterobacterales" value ="<?php echo $tax[5]; ?>">
                                        </div>                                  
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Order</label>
                                                <input type="text" class="form-control" name = "order_anti" id="anti" placeholder="e.g. " value ="<?php echo $tax[6]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Family</label>
                                                <input type="text" class="form-control" name = "family_anti" id="anti" placeholder="e.g. Enterobacteriaceae" value ="<?php echo $tax[7]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Genus</label>
                                                <input type="text" class="form-control" name = "genus_anti" id="anti" placeholder="e.g. Escherichia" value ="<?php echo $tax[8]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Species</label>
                                                <input type="text" class="form-control" name ="species_anti" id="anti" placeholder="e.g. Escherichia coli" value ="<?php echo $tax[9]; ?>">
                                        </div>                                  
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1">                                     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Sub Species</label>
                                                <input type="text" class="form-control" name ="sub_species_anti" id="anti" placeholder="e.g. Escherichia coli" value ="<?php echo $tax[10]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Taxonomy Pathovar</label>
                                                <input type="text" class="form-control" name ="taxon_pathovar" id="anti" placeholder="e.g. Escherichia coli" value ="<?php echo $tax[11]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Taxonomy Serotype</label>
                                                <input type="text" class="form-control" name ="taxon_serotype" id="anti" placeholder="e.g. " value ="<?php echo $tax[12]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Strain</label>
                                                <input type="text" class="form-control" name ="strain"id="anti" placeholder="e.g. CMC" value ="<?php echo $tax[13]; ?>">
                                        </div>                                  
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Sub Strain</label>
                                                <input type="text" class="form-control" name ="sub_strain" id="anti" placeholder="e.g. CMC" value ="<?php echo $tax[14]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Mol Type</label>
                                                <input type="text" class="form-control" name ="mol_type" id="anti" placeholder="5 charactors only" value ="<?php echo $idaa[1]; ?>">
                                        </div>                                  
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">Feat Type</label>
                                                <input type="text" class="form-control" name ="feat_type" id="anti" placeholder="e.g. 4762" value ="<?php echo $seq[5]; ?>">
                                        </div>                                  
                                    </div>
                                     <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">End 3</label>
                                                <input type="text" class="form-control" name = "end3" id="anti" placeholder="e.g. 3136" value ="<?php echo $seq[1]; ?>">
                                        </div>                                  
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1">     
                                        <div class="form-group">
                                            <label for="anti" class="control-label">End 5</label>
                                                <input type="text" class="form-control" name ="end5" id="anti" placeholder="e.g. 4762" value ="<?php echo $seq[2]; ?>">
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Isoloation Site</label>
                                                <input type="text" class="form-control" name ="isolation_site" id="meta" placeholder="e.g. " value="<?echo $meta[3];?>"">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Serotyping Method</label>
                                                <input type="text" class="form-control" name ="serotyping_method" id="meta" placeholder="e.g. " value="<?echo $meta[4];?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Source Common Name</label>
                                                <input type="text" class="form-control" name ="source_common_name" id="meta" placeholder="e.g. Rectal swab" value="<?echo $meta[5];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Collection Date</label>
                                                <input type="text" class="form-control" name = "specimen_collection_date" id="meta" placeholder="e.g. 01/01/2015" value="<?echo $meta[6];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Location Country</label>
                                                <input type="text" class="form-control" name ="specimen_location_country" id="meta" placeholder="e.g. India" value ="<?echo $meta[7];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Location</label>
                                                <input type="text" class="form-control" name ="specimen_location" id="meta" placeholder="e.g. India" value ="<?echo $meta[8];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                     
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Location Lattitude</label>
                                                <input type="text" class="form-control" name ="specimen_location_lattitude"  id="meta" placeholder="e.g. 39.09802374503313" value ="<?echo $meta[9];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Location Longitude</label>
                                                <input type="text" class="form-control" name = "specimen_location_longitude"id="meta" placeholder="e.g. -77.19469801321412" value ="<?echo $meta[10];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Source Age</label>
                                                <input type="text" class="form-control" name ="specimen_source_age" id="meta" placeholder="e.g. 32" value ="<?php echo $meta[11];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Development Stage</label>
                                                <input type="text" class="form-control" name ="specimen_dev_stage" id="meta" placeholder="e.g. 32" value ="<?echo $meta[12];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Source Disease</label>
                                                <input type="text" class="form-control" name ="specimen_source_disease" id="meta" placeholder="e.g. IBD" value ="<?php echo $meta[13];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Source Gender</label>
                                                <input type="text" class="form-control" name ="specimen_source_gender"id="meta" placeholder="e.g. Male" value ="<?echo $meta[14];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Health Status</label>
                                                <input type="text" class="form-control" name ="specimen_health_status"id="meta" placeholder="e.g. " value ="<?echo $meta[15];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Treatment</label>
                                                <input type="text" class="form-control" name ="specimen_treatment"id="meta" placeholder="e.g. " value ="<?echo $meta[16];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Type</label>
                                                <input type="text" class="form-control" name ="speciment_type"id="meta" placeholder="e.g. " value ="<?echo $meta[17];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Specimen Symptom</label>
                                                <input type="text" class="form-control" name ="speciment_symptom"id="meta" placeholder="e.g. " value ="<?echo $meta[18];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">                                 
                                        <div class="form-group">
                                            <label for="meta" class="control-label">Host</label>
                                                <input type="text" class="form-control" name ="speciment_Host"id="meta" placeholder="e.g. " value ="<?echo $meta[19];?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<SCRIPT TYPE="text/javascript">
  function addRow(in_tbl_name,add_options)
  {
    ...
    if(add_options=='varant'){
        ...
        let container_pas = document.getElementById(in_tbl_name);
        let outter_div=document.createElement('div');
        outter_div.setAttribute("id",'addon_fields'+v_count);
        container_pas.appendChild(outter_div);
        // create HR as a divider
        let hrcontain = document.getElementById('addon_fields'+v_count);
        let hr=document.createElement('hr');
        hr.style="border-color:#aaa";
        let coldiv1=document.createElement('div');
        coldiv1.className='col-sm-10 col-sm-offset-1';
        ...
        coldiv1.appendChild(groudiv2);
        coldiv1.appendChild(hr);
        addRow_helper('','addon_fields'+v_count,'SNP','snp['+count+'][]','e.g.xxxx',v_count);
        let groudiv=addRow_helper('','addon_fields'+v_count,'Variant PubMed ID','v_plasmid['+count+'][]','e.g.xxxx',v_count);
        // create remove button
        let removeMe=document.createElement("input");
        removeMe.type="Button";
        removeMe.className='red_buttond';
