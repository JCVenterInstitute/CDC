...
system("perl /www/projects/fmd/data/average/transpose.pl /www/projects/fmd/data/average/$selfile $site $names | egrep -v 'ID' | sort -grk2 | head -20 > $dir/data.txt");
#echo "perl /www/projects/fmd/data/average/transpose.pl /www/projects/fmd/data/average/$selfile $site $names | egrep -v 'ID' | sort -grk2 | head -20 > $dir/data.txt";
#}
...
system("perl /www/projects/fmd/data/average/transpose2.pl -i $dir/data.txt -o $dir/res.txt");
...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: '$genera Level Comparison of $snam'
            },
            subtitle: {
            ...
            tooltip: {
                formatter: function() {
                    return this.series.name +' has <b>'+
                        Highcharts.numberFormat(this.y, 0) +'</b><br/>percent composition of '+ this.x;
                }
            },
            plotOptions: {
                area: {
